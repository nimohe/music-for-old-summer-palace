  ...
  return (
    <div className="h-full flex flex-col p-2 md:p-0 overflow-hidden">
      ...
      <div className="mb-4 md:mb-8 flex-shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-x-4 md:gap-x-6 gap-y-1 text-xs md:text-sm text-gray-500">
      ...
      >
        <div className="py-[25vh] space-y-4 md:space-y-8">
            {lyrics.length > 0 ? (
              lyrics.map((lyric, index) => (
                <div 
                    ...
                    className={`transition-all duration-700 cursor-pointer whitespace-normal py-1 ${
                        index === activeIndex 
                        ? 'text-gray-900 text-lg md:text-2xl font-bold scale-105 origin-left' 
